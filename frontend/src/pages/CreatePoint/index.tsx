...
const CreatePoint = () => {
  ...
  useEffect(() => {
    axios.get<IBGEInitials[]>('https://servicodados.ibge.gov.br/api/v1/localidades/estados?orderBy=nome').then(response=> {
  ...
  async function handleSubmit(event: FormEvent) {
    ...
    // usando multipart form, ao invés de JSON para poder enviar file junto
